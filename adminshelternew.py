...
cur.execute("SELECT * FROM shelter_info WHERE status='pending'")
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow">
    ...
    <div class="container mt-5">
        <h2 class="section-title">Pending Shelter Applications</h2>
...
print("""                </tbody>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <img id="modalProfile" src="" alt="Profile" class="document-img">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <img id="modalLicense" src="" alt="License" class="document-img">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <img id="modalProof" src="" alt="Proof" class="document-img">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
    function openDocumentsModal(profile, license, proof, title) {
        ...
        document.getElementById('modalProof').src = './images/' + proof;
