...
sql = """
    ...
    WHERE b.id = %s AND b.status = 'adopted' 
...
if recent_orders:
    for i in recent_orders:
        ...
        id = i[1]  # b.id
        booking_date = i[27]  # b.booking_date
        ...
        print(f"""
                    <tr>
                        ...
                        <td>{booking_date}</td>
                        <td><span class="badge badge-adopted">Requested</span></td>
                        <td>
                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#detailsModal{id}">
                                <i class="fas fa-eye"></i> View Details
                            </button>
                            <button class="btn btn-sm btn-danger" onclick="cancelOrder({bookingid}, {Uid})">
...
print("""
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
        <script>
    function cancelOrder(bookingId, userId) {
        if (confirm("Are you sure you want to cancel this order?")) {
            // Create a form dynamically
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = 'cancel_order.py';
