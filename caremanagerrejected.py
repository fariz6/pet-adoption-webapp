...
cur.execute(
    "SELECT centertype,resourcername, centername, mail, mob, address, pin, state, city, Image, idproof FROM careresource_info WHERE status='rejected'")
...
for index, care in enumerate(care_data):
    ...
    profile_img = care[9] if care[9] and care[9] != "NULL" else "default_profile.jpg"
    ...
    print(f"""
                    <tr>
                        ...
                        <td>{care[2]}</td>
                        <td>
                            <i class="fas fa-phone"></i> {care[4] if care[4] and care[4] != '0' else 'N/A'}<br>
                            <i class="fas fa-envelope"></i> {care[3]}
                        </td>
                        <td>
                            {care[5]}, {care[6]}<br>
                            {care[8]}, {care[7]}
...
for index, care in enumerate(care_data):
    ...
    profile_img = care[9] if care[9] and care[9] != "NULL" else "default_profile.jpg"
    id_proof_img = care[10] if care[10] and care[10] != "NULL" else "default_proof.jpg"
